...
public class EjecutaMigraI2W {
    ...
    public void gestionaReinicioMigra(String keyForExecute) {
        ...
        String[] r;
        history.setDescription("Reinicio Tarea MIGRA: " + keyForExecute + " : " + localDateTime);
        ...
        if (CoreFunctions.getApplicationProperty("enviroment").equals("dev")) {
            if (keyForExecute.equals(ConstantesXMP.ALL_REGIONS)) {
                request = ConstantsWsdl.getI2W("I");
            ...
            for (String r1 : r) {
                request = ConstantsWsdl.getI2W(r1);
